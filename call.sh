# mr.foxs hacking terhebat di sini
clear
figlet "MR.FOX-S"
echo "----------------------------------"
echo "HACKER : MR.FOXS"
echo "TANGGAL: 26-11-25"
echo "TOOLS :  SPAM TLP"
echo "----------------------------------"
echo 
...
echo "[3] CALL/TLP TAHAP PERCOBAAN"
read -p "[?] PILIH BOY :  " pil;
#jan suka NYOLONG SC GUA
if [ $pil = 1 ]
then
read -p "Masukan nomor nya bangsad (88××): " nomor
...
if [ $pil = 2 ]
then
git clone https://github.com/Mrfoxs26/spamulti
cd spamulti
bash call.sh
1
git clone https://github.com/Mrfoxs26/spamulti
