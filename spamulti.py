...
'x-frontend-type': 'mobile',
     ...
     dataurl = {"phone":"0"+nom,"email":"mr.fox.s.261125@gmail.com","action":"register","password":""}
...
'accept-language':'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'
     ...
     dat = {"emailAddress":"mr.fox.s.261125@gmail.com","firstName":"Mr","lastName":"Foxs","mobileNumber":"0"+nom,"mccCardNumber":"","password":"Mrfoxs","referralCode":"","dateOfBirth":"26-11-2005","gender":"Male","registrationType":"N"}
     datj = json.dumps(dat)
     for x in range(5):
